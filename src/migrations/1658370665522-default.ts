...
export class default1658370665522 implements MigrationInterface {
  name = 'default1658370665522';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query('CREATE TABLE `accounts` (`CodCliente` int NOT NULL AUTO_INCREMENT, `nome` varchar(100) NOT NULL, `email` varchar(150) NOT NULL, `password` varchar(255) NOT NULL, `Valor` decimal NOT NULL, UNIQUE INDEX `IDX_ee66de6cdc53993296d1ceb8aa` (`email`), PRIMARY KEY (`CodCliente`)) ENGINE=InnoDB');
